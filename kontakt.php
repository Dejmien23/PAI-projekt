          ...
          <div class="content">
            <div class="row">
                <h3>Formularz kontaktowy</h3>
                  <form method="POST" action="'.kontakt_email($conn).'">
                    <div class="row gtr-uniform">
                      ...
                      <div class="col-6 col-12">
                        <input type="text" name="temat" id="temat" value="" placeholder="Temat" />
                      </div>
                      <div class="col-12">
                        <textarea name="textarea" id="textarea" placeholder="Napisz wiadomość" rows="6"></textarea>
                      </div>
                      <div class="col-12">
                        <ul class="actions">
                          <li><input name="submit-email" type="submit" value="Wyślij" class="primary" /></li>
